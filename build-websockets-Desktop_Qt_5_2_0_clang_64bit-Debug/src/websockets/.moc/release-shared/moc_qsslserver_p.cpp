...
#include "../../../../../websockets/src/websockets/qsslserver_p.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QSslServer_t, stringdata) + ofs \
...
void QSslServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QSslServer::sslErrors)) {
                *result = 0;
            }
        }
        {
            typedef void (QSslServer::*_t)(const QSslError & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QSslServer::peerVerifyError)) {
                *result = 1;
            }
        }
        {
            typedef void (QSslServer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QSslServer::newEncryptedConnection)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject QSslServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_QSslServer.data,
      qt_meta_data_QSslServer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QSslServer.stringdata))
