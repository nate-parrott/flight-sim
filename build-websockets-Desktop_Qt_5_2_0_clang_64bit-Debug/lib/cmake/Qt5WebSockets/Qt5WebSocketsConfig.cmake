...
set(Qt5WebSockets_VERSION_STRING 5.2.0)
...
if (NOT TARGET Qt5::WebSockets)
    ...
    set(Qt5WebSockets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebSockets_install_prefix}/lib/QtWebSockets.framework/Versions/5/Headers/5.2.0/"
        "${_qt5WebSockets_install_prefix}/lib/QtWebSockets.framework/Versions/5/Headers/5.2.0/QtWebSockets"
    )
    ...
    foreach(_module_dep ${_Qt5WebSockets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.2.0 ${_Qt5WebSockets_FIND_VERSION_EXACT}
    ...
    if (Qt5WebSockets_EXECUTABLE_COMPILE_FLAGS)
