...
char list_is_full(list2 *listo)
{
	return(listo->item_count == listo->current_max_size);
}

void list_grow(list2 *old_listo)
{
	int i;
	list2 new_listo;
...
void list_make(list2 *listo, int start_size, char growable)
{
...
void* list_get_name(list2 *listo, char *name_to_find)
{
	int i = 0;
